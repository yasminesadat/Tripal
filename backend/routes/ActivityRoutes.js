...
const { createActivity, getAdvertiserActivities, updateActivity, deleteActivity, viewUpcomingActivities, viewPaidActivities, bookActivity } = require('../controllers/ActivityController');
