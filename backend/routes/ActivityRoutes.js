...
const { createActivity, getAdvertiserActivities, updateActivity, deleteActivity, viewUpcomingActivities, viewPaidActivities, addActivityComment, getActivityComments,bookActivity } = require('../controllers/ActivityController');
