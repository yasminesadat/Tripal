...
const { createTourist, updateTouristProfile, getTouristInfo, redeemPoints, getTouristNameAndEmail, getTouristBookedFlights, getTouristAge, getTouristBookedHotels, getTouristPreferences, getTouristCategories, checkUserExists } = require('../controllers/TouristController.js');
...
router.get("/tourist/preferences/:id", getTouristPreferences);
router.get("/tourist/categories/:id", getTouristCategories);
