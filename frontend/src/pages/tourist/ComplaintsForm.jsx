...
const ComplaintsForm = ({ open, onCancel, onSubmitSuccess }) => {  // Add onSubmitSuccess prop
        ...
        >
            <div className="modal-content">
                <div className="illustration-section">
                    ...
                    <p className="modal-quote">"Your feedback helps us improve and serve you better"</p>
                </div>
    ...
    /* Update the close (X) button styling */
    .complaints-modal .ant-modal-close {
        color: white;
...
.complaints-modal .ant-modal-close-x {
    ...
    /* Update the cancel button styling */
    .cancel-button {
    ...
    /* Update submit button to match cancel button height */
    .submit-button {
        height: 36px;
        border-radius: 20px;
        font-weight: 500;
